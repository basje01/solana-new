...
1. Check for `.solana-new/idea-context.json` in the workspace. If found, load the chosen idea. If not, ask the user to describe their idea.
...
1. Update `.solana-new/idea-context.json` with a `validation` field containing:
